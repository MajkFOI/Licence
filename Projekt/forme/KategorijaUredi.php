<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $upit = "update kategorija set naziv = '{$_POST['naziv']}' where id = $id";
        $rezultat = $veza->updateDB($upit);
        
        $veza->zatvoriDB();

        header("Location: KategorijaPopis.php?rezultat={$rezultat}");
    }
        ...
        $upit = "select * from kategorija where id = {$kategorijaID}";
        ...
        header("Location: KategorijaPopis.php");
    }
?>
﻿<!DOCTYPE html>
<html lang="hr" >
    ...
    <section>
        <form id="form1" enctype="multipart/form-data" method="post" action="">
            <div class="odjeljak">
                <h3> Uredi kategoriju <?php echo $red['naziv'] ?></h3>
                <input name="id" type="text" value="<?php echo $red['id']; ?>" readonly="readonly">
            </div>
             <div class="odjeljak">
