...
<html lang="hr" >
    ...
    <header id="headerObrazac">
	   <div class = "container">
            <h2> <span class = "zutiTekst"> Pregled kategorija </span></h2>
            <nav>
                <ul>
                ...
                <?php
                    ...
                    foreach ($nizZapisa as $value) {
                        ...
                        echo  "<td> ID: {$value[0]} </td> "
                            . "<td>  Naziv: {$value[1]} </td> "
                            . "<td> <button type='button' onclick=location.href='KategorijaUredi.php?KategorijaID={$value[0]}'> Uredi </button> </td>";  
                        echo '</tr>';
                    }                
                ?>
                </table>
